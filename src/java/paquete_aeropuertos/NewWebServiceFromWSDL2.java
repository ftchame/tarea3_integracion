 ...
 * @author Fernando
 */
@WebService(serviceName = "airport", portName = "airportSoap", endpointInterface = "net.webservicex.AirportSoap", targetNamespace = "http://www.webserviceX.NET", wsdlLocation = "WEB-INF/wsdl/NewWebServiceFromWSDL2/airport.asmx.xml.wsdl")
public class NewWebServiceFromWSDL2 {
